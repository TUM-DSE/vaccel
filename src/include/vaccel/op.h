...
#define VACCEL_OP_TYPE_ENUM_LIST(VACCEL_ENUM_ITEM)            \
	...
	VACCEL_ENUM_ITEM(MATMUL_CREATE, _ENUM_PREFIX)         \
	VACCEL_ENUM_ITEM(CREATE_MEM, _ENUM_PREFIX)            \
	VACCEL_ENUM_ITEM(DESTROY_MEM, _ENUM_PREFIX)           \
	VACCEL_ENUM_ITEM(MATMUL_DESTROY, _ENUM_PREFIX)        \
	VACCEL_ENUM_ITEM(MATMUL_SET_IO, _ENUM_PREFIX)         \
	VACCEL_ENUM_ITEM(MATMUL_SET_CORE_MASK, _ENUM_PREFIX)  \
	VACCEL_ENUM_ITEM(MATMUL_RUN, _ENUM_PREFIX)            \
	VACCEL_ENUM_ITEM(MATMUL_SET_MATRIX, _ENUM_PREFIX)     \
	VACCEL_ENUM_ITEM(MATMUL_GET_MATRIX, _ENUM_PREFIX)     \
	VACCEL_ENUM_ITEM(MATMUL_GET_PROPS, _ENUM_PREFIX)     \
